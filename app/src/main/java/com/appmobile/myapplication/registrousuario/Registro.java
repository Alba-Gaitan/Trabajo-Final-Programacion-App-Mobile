package com.appmobile.myapplication.registrousuario;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //obtenemos el texto que escribimos en el campo contraseña
                ...
                if (TextUtils.isEmpty(S_password)){
                    ...
                    //Pasamos los datos introducidos en los edittext al Share Preference
