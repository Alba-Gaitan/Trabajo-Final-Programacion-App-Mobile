package com.appmobile.myapplication.opcionespassword;
...
public class Agregar_Actualizar_Registro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Btn_Adjuntar_Imagen.setOnClickListener(new View.OnClickListener() {
            ...
            //Si tenemos el permiso llamamos al metodo tomar fotografia, caso contrario vuelve a pedir al usuario permiso para tomar foto
            @Override
...
//    creamos el menu y se establece q el menu que se esta creando es el de menu_guardar.xml
    @Override
    ...
    //Aca establecemos el permiso para acceder a la camara
